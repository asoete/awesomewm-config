...
globalkeys = gears.table.join(
    ...
    awful.key({ "Control", "Mod1"}, "Up",   awful.tag.viewprev,
              {description = "view previous", group = "tag"}),
    awful.key({ "Control", "Mod1"}, "Down",  awful.tag.viewnext,
    ...
    -- Prompt
    awful.key({ modkey }, "d",
              function () awful.util.spawn_with_shell("~/projects/launcher/@rofi -show combi") end,
              {description = "run prompt", group = "launcher"}
    ),

    -- Raise windows / applications
    awful.key({ modkey }, "f",
              function () awful.util.spawn_with_shell("~/projects/launcher/raise-window.sh firefox") end,
              {description = "Raise Firefox", group = "launcher"}
    ),
    awful.key({ modkey }, "e",
    ...
    awful.key({ modkey }, "w",
              ...
              {description = "Raise Any Window", group = "launcher"}
    ),

    -- Time tracking
    awful.key({ modkey }, "t",
              function () awful.util.spawn_with_shell("/home/arnes/bin/@tt") end,
              {description = "Launch @tt", group = "launcher"}
    ),
